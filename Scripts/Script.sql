...
CREATE TABLE CUR_Carrera (
  ...
  UnidadAcademica INTEGER NOT NULL,
  PRIMARY KEY (Carrera),
    FOREIGN KEY (Centro,UnidadAcademica)
    REFERENCES ADM_Centro_UnidadAcademica (Centro,UnidadAcademica));
...
-- -----------------------------------------------------
-- Table CUR_Seccion_Horario
-- -----------------------------------------------------
CREATE TABLE CUR_Seccion_Horario (
  Horario SERIAL NOT NULL,
