...
<html lang="en">
    ...
    <body id="page-top">
        <iframe scrolling="auto" src="encabezado.php" frameborder="0" height="50" width="100%"></iframe>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="service-box">
                            ...
                            <p class="text-muted">Alumnos y catedráticos</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="service-box">
                    ...
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="service-box">
                            ...
                            <h3>Gesti&oacute;n de asignaciones</h3>
                    ...
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="service-box">
                            <i class="fa fa-4x fa-gear wow bounceIn text-primary" data-wow-delay=".2s"></i>
                            <h3>Configuración</h3>
                            <p class="text-muted">Otras configuraciones del sistema</p>
                        </div>
                    </div>
                </div>
            </div>
