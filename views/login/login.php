...
<section class="no-padding" id="log">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 text-center">
                ...
                <p class="text-faded">
                    Aunque ya existía una unidad de investigación, por diversas razones, principalmente por falta de presupuesto, tuvo un largo periodo de inactividad. Fue hasta el año de 1986 cuando se logró el funcionamiento del Instituto de Investigaciones Históricas, Antropológicas y Arqueológicas.
                </p>
            </div>
        </div>
    </div>
                ...
                <form class="col-md-10 col-md-offset-1 col-xs-12 col-xs-offset-0" id="frLogin" method="post" action="<?php echo BASE_URL; ?>login/autenticar">
                    <div class="form-group">
                        <table>
                            ...
                            <tr>
                                <td>
                                    <input id="usuario" name="usuario" type="number" class="form-control input-lg" placeholder="Usuario"><br/>
