                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <?php if($_SESSION['rol'] == 1): ?>
                            <a href="<?php echo BASE_URL ?>estudiante/inicio">Regresar</a>
                        <?php elseif($_SESSION['rol'] == 2): ?>
                            <a href="<?php echo BASE_URL ?>catedratico/inicio">Regresar</a>
                        <?php elseif($_SESSION['rol'] == 3 || $_SESSION['rol'] == 0): ?>
                            <a href="<?php echo BASE_URL ?>gestionUsuario">Regresar</a>
                        <?php endif;?>
                        </i>
                    </div>
                </div>
