        ...
        <div class="row">
            <div class="col-lg-4 col-md-8 text-center">
                <div class="service-box">
                    ...
                    <p class="text-muted">Listado de notas de los cursos impartidos por el catedratico</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-8 text-center">
                <div class="service-box">
                    ...
                    <p class="text-muted">Listado de cursos asignados y opcion para ingresar notas</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-8 text-center">
                <div class="service-box">
                    ...
                    <p class="text-muted">Listado de estudiantes asignados con el catedratico</p>
                </div>
            </div>
        </div>
    </div>
